...
This tutorial in particular deals with techniques to inject constraints in Machine Learning models, and some of their applications. In particular, the lecture will cover injecting domain knowledge via Lagragian regularizers, enforcing shape constraints (e.g. monotonicity) in Lattice Models, and a method to calibrate Lagrangian regularizers applied to the construction of fair classifiers.
